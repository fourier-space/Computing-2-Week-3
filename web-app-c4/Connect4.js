...
const remove_zeros = R.reject(R.equals(0));
...
const place_token_in_column = function (token, column) {
    return R.update(R.indexOf(0, column), token, column);
};
...
Connect4.ply = function (token, column_index, board) {
    ...
    return R.update(column_index, updated_column, board);
};
